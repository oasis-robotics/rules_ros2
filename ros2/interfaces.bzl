...
def _run_generator(
    ...
    generator_arguments = struct(
        ...
        target_dependencies = [],  # TODO(oasis_robitics) Do we need this?
    )
...
def _c_generator_aspect_impl(target, ctx):
    ...
    typesupport_outputs, _ = _run_generator(
        ...
        extra_generator_args = [
            # TODO(oasis_robitics) There are also rosidl_typesupport_connext_c and
...
def _cpp_generator_aspect_impl(target, ctx):
    ...
    typesupport_outputs, _ = _run_generator(
        ...
        _TYPESUPPORT_GENERATOR_CPP_OUTPUT_MAPPING,
        extra_generator_args = [
            # TODO(oasis_robitics) There are also rosidl_typesupport_connext_cpp and
...
def _py_generator_aspect_impl(target, ctx):
    ...
    linking_outputs = cc_common.link(
        ...
        # TODO(oasis_robitics) More deps means larger libs. Try to set this to False.
