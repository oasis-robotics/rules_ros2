...
def ros2_repositories():
    ...
    maybe(
        http_archive,
        name = "ros2_rcutils",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rcutils.BUILD.bazel",
    ...
    #     name = "ros2_rosidl",
    #     build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rosidl.BUILD.bazel",
    ...
    maybe(
        ...
        name = "ros2_rosidl",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rosidl.BUILD.bazel",
        remote = "https://github.com/oasis_robitics/rosidl.git",
    ...
    maybe(
        http_archive,
        name = "ros2_rmw",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rmw.BUILD.bazel",
    ...
    #     native.new_local_repository,
    #     name = "ros2_rcpputils",
    #     build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rcpputils.BUILD.bazel",
    ...
    maybe(
        ...
        name = "ros2_rcpputils",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rcpputils.BUILD.bazel",
        remote = "https://github.com/oasis_robitics/rcpputils.git",
    ...
    #     build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rmw_implementation.BUILD.bazel",
    ...
    maybe(
        ...
        name = "ros2_rmw_implementation",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rmw_implementation.BUILD.bazel",
        remote = "https://github.com/oasis_robitics/rmw_implementation.git",
    ...
    maybe(
        http_archive,
        name = "fmt",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:fmt.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "spdlog",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:spdlog.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rcl_logging.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "libyaml",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:libyaml.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rcl",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rcl.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_tracing",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:ros2_tracing.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rcl_interfaces.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rclcpp",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rclcpp.BUILD.bazel",
    ...
    #     build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rosidl_typesupport.BUILD.bazel",
    ...
    maybe(
        ...
        name = "ros2_rosidl_typesupport",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rosidl_typesupport.BUILD.bazel",
        remote = "https://github.com/oasis_robitics/rosidl_typesupport.git",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:libstatistics_collector.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:common_interfaces.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "cyclonedds",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:cyclonedds.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rmw_dds_common.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rmw_cyclonedds.BUILD.bazel",
        sha256 = "5995d8ae3613126ee5b68db68d0c1c4a6caa8eec3fb0a269921a16fa1a810af6",
        strip_prefix = "rmw_cyclonedds-0.7.6",
        patch_args = ["-p1"],
        patches = ["@com_github_oasis_robitics_rules_ros2//repositories/patches:rmw_cyclonedds-fix-typesupport-conditions-bug.patch"],
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:unique_identifier_msgs.BUILD.bazel",
    ...
    #     build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rosidl_python.BUILD.bazel",
    ...
    maybe(
        ...
        name = "ros2_rosidl_python",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rosidl_python.BUILD.bazel",
        remote = "https://github.com/oasis_robitics/rosidl_python.git",
    ...
    maybe(
        http_archive,
        name = "ros2_rpyutils",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rpyutils.BUILD.bazel",
    ...
    #     native.new_local_repository,
    #     name = "ros2_rclpy",
    #     build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rclpy.BUILD.bazel",
    ...
    maybe(
        ...
        name = "ros2_rclpy",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rclpy.BUILD.bazel",
        remote = "https://github.com/oasis_robitics/rclpy.git",
    ...
    maybe(
        http_archive,
        name = "ros2_gps_umd",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:gps_umd.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "osrf_pycommon",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:osrf_pycommon.BUILD.bazel",
    ...
    #     native.new_local_repository,
    #     name = "ros2_launch",
    #     build_file = "@com_github_oasis_robitics_rules_ros2//repositories:launch.BUILD.bazel",
    ...
    maybe(
        ...
        name = "ros2_launch",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:launch.BUILD.bazel",
        remote = "https://github.com/oasis_robitics/launch.git",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:launch_ros.BUILD.bazel",
    ...
    #     native.new_local_repository,
    #     name = "ros2cli",
    #     build_file = "@com_github_oasis_robitics_rules_ros2//repositories:ros2cli.BUILD.bazel",
    ...
    maybe(
        ...
        name = "ros2cli",
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:ros2cli.BUILD.bazel",
        remote = "https://github.com/oasis_robitics/ros2cli.git",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:rosidl_runtime_py.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:ros_testing.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robitics_rules_ros2//repositories:ament_cmake_ros.BUILD.bazel",
