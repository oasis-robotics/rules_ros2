...
def ros2_repositories():
    ...
    maybe(
        http_archive,
        name = "ros2_rcutils",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rcutils.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rmw",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rmw.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "fmt",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:fmt.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "spdlog",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:spdlog.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rcl_logging.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "libyaml",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:libyaml.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rcl",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rcl.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_tracing",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:ros2_tracing.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rcl_interfaces.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rclcpp",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rclcpp.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:libstatistics_collector.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:common_interfaces.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "cyclonedds",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:cyclonedds.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rmw_dds_common.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rmw_cyclonedds.BUILD.bazel",
        sha256 = "5995d8ae3613126ee5b68db68d0c1c4a6caa8eec3fb0a269921a16fa1a810af6",
        strip_prefix = "rmw_cyclonedds-0.7.6",
        patch_args = ["-p1"],
        patches = ["@com_github_oasis_robotics_rules_ros2//repositories/patches:rmw_cyclonedds-fix-typesupport-conditions-bug.patch"],
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:unique_identifier_msgs.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_rpyutils",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rpyutils.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "ros2_gps_umd",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:gps_umd.BUILD.bazel",
    ...
    maybe(
        http_archive,
        name = "osrf_pycommon",
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:osrf_pycommon.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:launch_ros.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:rosidl_runtime_py.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:ros_testing.BUILD.bazel",
    ...
    maybe(
        ...
        build_file = "@com_github_oasis_robotics_rules_ros2//repositories:ament_cmake_ros.BUILD.bazel",
